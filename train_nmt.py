...
from libs.models import TModel
import theano
...
def main():
    ...
    parser.add_argument('--teacher_batch_size', action='store', default=4, type=int, dest='teacher_batch_size',
                        help='Batch size of teacher model, default to 4')
    parser.add_argument('--update_frequence_batches', action='store', default=10, type=int, dest='update_frequence_batches',
